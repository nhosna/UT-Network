...
<td class="border-0" style="{{monthTdStyle}}" {{monthTdAttribute}} data-td-month>
  ...
  var previousYearTextPersian = 'Previous Year',
    previousMonthTextPersian = 'Previous Month',
    previousTextPersian = 'Previous',
    nextYearTextPersian = 'Next Year',
    nextMonthTextPersian = 'Next Month',
    nextTextPersian = 'Next',
    hourTextPersian = 'Hour',
    minuteTextPersian = 'Minute',
    secondTextPersian = 'Second',
    goTodayTextPersian = 'Go Today',
...
`;
  ...
  function getDateTimePickerHtml(setting) {
    ...
    todayDateString = `${setting.isGregorian ? 'Today,' : 'Today,'} ${todayDateTimeJson.day} ${getMonthName(todayDateTimeJson.month - 1, setting.isGregorian)} ${todayDateTimeJson.year}`;
