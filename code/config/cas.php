...
//    'cas_hostname'        => env('CAS_HOSTNAME', 'cas.myuniv.edu'),
    'cas_hostname'        => env('CAS_HOSTNAME', 'auth.ut.ac.ir'),
...
//    'cas_real_hosts'      => env('CAS_REAL_HOSTS', 'cas.myuniv.edu'),
    'cas_real_hosts'      => env('CAS_REAL_HOSTS', 'auth.ut.ac.ir'),
    ...
    */
    ...
    | Empty is fine
    */
    'cas_login_url'       => env('CAS_LOGIN_URL', 'https://auth.ut.ac.ir/cas/login?service=https://127.0.0.1:8000?ut=1%26CSURL=https://auth.ut.ac.ir:8443/cas/logout?service$https://127.0.0.1:8000'),
    ...
    |--------------------------------------------------------------------------
    */
    'cas_logout_url'      => env('CAS_LOGOUT_URL', 'https://auth.ut.ac.ir/cas/logout'),
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    'cas_debug'           => env('CAS_DEBUG', '/home/nhosna/PhpstormProjects/UTForum/blog/storage/logs/phpCas.log'),
